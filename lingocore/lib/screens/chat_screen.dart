...
class _ChatScreenState extends State<ChatScreen>
  ...
  void initState() {
    ...
    messages = [
      ...
      Message(
        text: "Hi Alice!",
        date: DateTime(2025, 5, 1, 9, 5),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Good morning!",
        date: DateTime(2025, 5, 1, 9, 10),
        isMe: false,
        username: "Bob",
      ),
      Message(
      ...
      Message(
        ...
        date: DateTime(2025, 5, 1, 9, 20),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "What about you?",
        date: DateTime(2025, 5, 1, 9, 25),
        isMe: false,
        username: "Alice",
      ),
      Message(
      ...
      Message(
        ...
        date: DateTime(2025, 5, 2, 10, 15),
        isMe: false,
        username: "Bob",
      ),
      Message(
        text: "Yeah, it is!",
        date: DateTime(2025, 5, 2, 10, 20),
        isMe: true,
        username: "Me",
      ),
      Message(
      ...
      Message(
        ...
        date: DateTime(2025, 5, 3, 11, 5),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Let me know if you do.",
        date: DateTime(2025, 5, 3, 11, 10),
        isMe: false,
        username: "Alice",
      ),
      Message(
        text: "Sure, will do!",
        date: DateTime(2025, 5, 3, 11, 15),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "How's the weather there?",
        date: DateTime(2025, 5, 4, 12, 0),
        isMe: false,
        username: "Bob",
      ),
      Message(
        text: "It's sunny and warm.",
        date: DateTime(2025, 5, 4, 12, 5),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Lucky you! It's raining here.",
        date: DateTime(2025, 5, 4, 12, 10),
        isMe: false,
        username: "Charlie",
      ),
      Message(
        text: "Oh no, stay dry!",
        date: DateTime(2025, 5, 4, 12, 15),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Will do, thanks!",
        date: DateTime(2025, 5, 5, 13, 0),
        isMe: false,
        username: "Alice",
      ),
      Message(
        text: "Any plans for the weekend?",
        date: DateTime(2025, 5, 5, 13, 5),
        isMe: false,
        username: "Bob",
      ),
      Message(
        text: "Not yet, you?",
        date: DateTime(2025, 5, 5, 13, 10),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Thinking of going hiking.",
        date: DateTime(2025, 5, 5, 13, 15),
        isMe: false,
        username: "Charlie",
      ),
      Message(
        text: "That sounds fun!",
        date: DateTime(2025, 5, 5, 13, 20),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Yeah, I hope the weather stays good.",
        date: DateTime(2025, 5, 6, 14, 0),
        isMe: false,
        username: "Alice",
      ),
      Message(
        text: "Fingers crossed!",
        date: DateTime(2025, 5, 6, 14, 5),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "What about you?",
        date: DateTime(2025, 5, 6, 14, 10),
        isMe: false,
        username: "Bob",
      ),
      Message(
        text: "Might just relax at home.",
        date: DateTime(2025, 5, 6, 14, 15),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "That sounds nice too.",
        date: DateTime(2025, 5, 6, 14, 20),
        isMe: false,
        username: "Charlie",
      ),
      Message(
        text: "Yeah, I need a break.",
        date: DateTime(2025, 5, 7, 15, 0),
        isMe: true,
        username: "Me",
      ),
      Message(
        text: "Take care!",
        date: DateTime(2025, 5, 7, 15, 5),
        isMe: false,
        username: "Alice",
      ),
      Message(
        text: "You too!",
        date: DateTime(2025, 5, 7, 15, 10),
        isMe: true,
        username: "Me",
      ),
    ];
